...
if [ "$(uname -m)" = "aarch64" ]; then
  ...
  curl -L -o "/osv-scanner/osv-scanner.zip" "https://github.com/DataDog/osv-scanner/releases/download/v0.10.0/osv-scanner_linux_arm64.zip" >/dev/null 2>&1 || exit 1
else
  echo "Installing osv-scanner for AMD64"
  curl -L -o "/osv-scanner/osv-scanner.zip" "https://github.com/DataDog/osv-scanner/releases/download/v0.10.0/osv-scanner_linux_amd64.zip" >/dev/null 2>&1 || exit 1
fi
